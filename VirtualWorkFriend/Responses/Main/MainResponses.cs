...
namespace MyAssistant_1.Responses.Main
{
    public class MainResponses : TemplateManager
    {
        ...
        //{
        //    var introCard = File.ReadAllText(MainStrings.VIDEO_PATH);
        //    var card = AdaptiveCard.FromJson(introCard).Card;
        //    //var attachment = new Attachment(AdaptiveCard.ContentType, content: card);
        //    var attachment = new Attachment(contentType: "video/mp4", name: "See some videos",
        //        thumbnailUrl: "",
        //        contentUrl: "https://www.youtube.com/watch?v=m6buIdQacoM&t=3s");
