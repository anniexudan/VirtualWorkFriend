...
using MyAssistant_1.Responses.Cancel;
using MyAssistant_1.Responses.Main;
...
namespace MyAssistant_1.Dialogs
{
    public class MainDialog : RouterDialog
    {
        ...
        public MainDialog(
            ...
            EntertainDialog entertainDialog,
        ...
        protected override async Task RouteAsync(DialogContext dc, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (intent == DispatchLuis.Intent.l_general)
            {
            ...
            else if (intent == DispatchLuis.Intent.q_virtualworkfriendcustomkb)
            {
                cognitiveModels.QnAServices.TryGetValue("virtualworkfriendcustomkb", out var qnaService);
                ...
                if (answers != null && answers.Length > 0)
                {
                    ...
                    // force the Stress Dialog if needed
                    if (answers[0].Questions[0] == "Being sad is the worst")
                    {
                        await dc.BeginDialogAsync(nameof(StressDialog));
                    }
                }
                else
                {
